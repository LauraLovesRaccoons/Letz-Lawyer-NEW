...
<div class="antialiased sans-serif h-screen" style="width: 50%;position:absolute;top:45px;right:30px;border-radius:20px">
	...
	<script>
        ...
        <div class="max-w-lg bg-white shadow-xl rounded-lg p-8" style="width:550px;border-radius:50px;height:550px;display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;margin-left:40px">
            <img src="/images/coche.png" style="width: 100px;margin-top:80px" alt="">
            <p style="color: #50AD41; font-size:2em;text-align:center">Appointment</p> 
            <br>  
            ...
            <div class="text-center my-4">
                <a class="text-base text-indigo-500 italic hover:underline hover:text-indigo-600 font-medium" href="#">Done</a>
            </div>
            <br>
        </div>
