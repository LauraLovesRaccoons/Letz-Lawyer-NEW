...
@section('content')
<x-card x-data={show:false} class="p-10">
    <header>
        ...
        <tbody>
            @unless($lawyers->isEmpty())
                ...
                <tr class="border-gray-300">
                    ...
                    <td class="px-4 py-8 border-t border-b border-gray-300 text-lg">
                        <button x-on:click="show = true" class="text-red-500">
                    ...
                    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div
                            ...
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Delete lawyer
                                        </h3>
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">Are you sure you want to delete this lawyer listing?
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <form action="/lawyers/{{ $lawyer->id }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button
